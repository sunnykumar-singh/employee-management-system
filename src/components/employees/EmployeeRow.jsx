...
const EmployeeRow = ({ employee, onDelete, onEdit, onView }) => (
  <tr className="border-b border-[#edf1f6] last:border-0 hover:bg-[#fafbff]">
    <td className="px-3 py-3 text-[11px] text-[#344767]">{employee.id}</td>
    <td className="px-3 py-3 text-[11px] font-medium text-[#101828]">{employee.employeeId}</td>
    <td className="px-3 py-3"><div className="flex items-center gap-2"><span className="flex size-7 items-center justify-center rounded-full text-[8px] font-bold text-white" style={{ backgroundColor: employee.avatar }}><UserRound size={15} /></span><span className="whitespace-nowrap text-[11px] font-medium text-[#101828]">{employee.name}</span></div></td>
