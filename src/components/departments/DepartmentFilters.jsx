...
const DepartmentFilters = ({ filters, headOptions, onFilterChange, searchQuery, onSearchChange }) => (
  <section className="flex flex-wrap gap-3 rounded-t-xl border border-[#e4eaf2] bg-white px-4 py-4 shadow-[0_2px_8px_rgba(16,24,40,0.02)] sm:px-5">
    ...
    <FilterDropdown label="Status" options={departmentFilterOptions.statuses} value={filters.status} onChange={(value) => onFilterChange('status', value)} />
