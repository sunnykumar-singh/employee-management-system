...
const DepartmentRow = ({ department, serialNumber, onView, onEdit, onDelete }) => {
  ...
  return <tr className="border-b border-[#edf1f6] last:border-0 hover:bg-[#fafbff]">
    ...
    <td className="px-5 py-3.5 text-[11px] text-[#101828]">{department.employees}</td>
    <td className="max-w-[290px] px-5 py-3.5 text-[11px] leading-[1.35] text-[#101828]">{department.description}</td>
