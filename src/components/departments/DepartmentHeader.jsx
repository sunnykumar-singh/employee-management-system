...
const DepartmentHeader = () => (
  <header className="flex flex-wrap items-start justify-between gap-4">
    ...
    <button className="flex items-center gap-2 rounded-md bg-[#4b3df2] px-4 py-2.5 text-xs font-medium text-white shadow-[0_4px_9px_rgba(75,61,242,0.25)] transition hover:bg-[#4032e8]" type="button"><Plus size={15} /> Add Department</button>
  </header>
);
